...
class TestFileExistsWaitStrategy:
    ...
    # Removed test_file_exists_wait_strategy_real_file - real file operations belong in integration tests
...
class TestCompositeWaitStrategy:
    ...
    # Removed test_composite_with_real_strategies - real file operations belong in integration tests
