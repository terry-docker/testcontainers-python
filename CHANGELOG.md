...
## [5.0.0](https://github.com/terry-docker/testcontainers-python/compare/testcontainers-v4.12.0...testcontainers-v5.0.0) (2025-08-06)
...
* **core:** DockerCompose.stop now stops only services that it starts (does not stop the other services) ([#620](https://github.com/terry-docker/testcontainers-python/issues/620)) ([e711800](https://github.com/terry-docker/testcontainers-python/commit/e71180039441e3c7d49467298ef0f498fe786149))
...
* **main:** New Testcontainers Python Docs Site ([#822](https://github.com/terry-docker/testcontainers-python/issues/822)) ([a6bdf0e](https://github.com/terry-docker/testcontainers-python/commit/a6bdf0ef84643074fbc7edf3a75936ce3f1d0880))
* make config monkeypatchable, fix config related startup issues ([#833](https://github.com/terry-docker/testcontainers-python/issues/833)) ([ff6a32d](https://github.com/terry-docker/testcontainers-python/commit/ff6a32db803046db8d89ba5a7157bf573d9f25c2))
* **modules:** add OpenFGA module ([#762](https://github.com/terry-docker/testcontainers-python/issues/762)) ([0b7b482](https://github.com/terry-docker/testcontainers-python/commit/0b7b482f9ec807e87fd43d1372226fa43eb4ed7c))
...
* set multiple variables via keyword args ([#804](https://github.com/terry-docker/testcontainers-python/issues/804)) ([1532df5](https://github.com/terry-docker/testcontainers-python/commit/1532df5e9094d15b9f3e9233e7f5843d8bc24386))
...
* Add memcached container ([#322](https://github.com/terry-docker/testcontainers-python/issues/322)) ([690b9b4](https://github.com/terry-docker/testcontainers-python/commit/690b9b4526dcdf930c0733c227009af208f47cda))
...
* **core:** Add kwargs to image build ([#708](https://github.com/terry-docker/testcontainers-python/issues/708)) ([cc02f94](https://github.com/terry-docker/testcontainers-python/commit/cc02f9444b41efa62836b21210b07aee1da94d0b))
...
* **core:** mypy ([#810](https://github.com/terry-docker/testcontainers-python/issues/810)) ([b816762](https://github.com/terry-docker/testcontainers-python/commit/b816762b9a548033b065c3f46267c289a560f6ed))
...
* **core:** Typing in docker_client ([#702](https://github.com/terry-docker/testcontainers-python/issues/702)) ([e8bf224](https://github.com/terry-docker/testcontainers-python/commit/e8bf2244c7210e31b34e5fecf2602fdd1b8c0834))
...
* Enable mypy in the CI ([#842](https://github.com/terry-docker/testcontainers-python/issues/842)) ([ef65bd1](https://github.com/terry-docker/testcontainers-python/commit/ef65bd113b564bce614aaf6df13bbf5339b9bc58))
...
* just use the getLogger API and do not override logger settings ([#836](https://github.com/terry-docker/testcontainers-python/issues/836)) ([f467c84](https://github.com/terry-docker/testcontainers-python/commit/f467c842b851613b9a087bd5f9a08d8c39577cb8))
...
* **kafka:** Add Kraft to Kafka containers ([#611](https://github.com/terry-docker/testcontainers-python/issues/611)) ([762d2a2](https://github.com/terry-docker/testcontainers-python/commit/762d2a2130f7ce17dacaed5a96a6898a08cf2bc5))
...
* mysql typo ([#705](https://github.com/terry-docker/testcontainers-python/issues/705)) ([85d6078](https://github.com/terry-docker/testcontainers-python/commit/85d6078f9bcc99050c0173e459208402aa4f5026)), closes [#689](https://github.com/terry-docker/testcontainers-python/issues/689)
...
* readthedocs build - take 1 ([#495](https://github.com/terry-docker/testcontainers-python/issues/495)) ([b3b9901](https://github.com/terry-docker/testcontainers-python/commit/b3b990159154857239e2fb86da3cb85a6a13ab8e))
...
* wait_for_logs can now fail early when the container stops ([#682](https://github.com/terry-docker/testcontainers-python/issues/682)) ([925329d](https://github.com/terry-docker/testcontainers-python/commit/925329d8d2df78437a491a29b707d5ac97e7b734))
...
* missing compose html from old docs ([#776](https://github.com/terry-docker/testcontainers-python/issues/776)) ([d749fc6](https://github.com/terry-docker/testcontainers-python/commit/d749fc69b32715742d834c003ee6893e2077753a))
